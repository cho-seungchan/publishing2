...
const normal = document.querySelector("#normal_user");
const companybutton = document.querySelector("#companyMenuButton");
const normalbutton = document.querySelector("#normal_M");
...
companybutton.addEventListener("click", () => {
  ...
  if (company.style.display == "none") {
    company.style.display = "block"; // 숨겨져 있으면 보이게
  }
  // 보이면 숨기기
});
