...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initializeEventListeners() {
    try {
      ...
      // 모달 닫기 버튼 처리
      if (memberCloseBtn) {
        memberCloseBtn.addEventListener("click", () => closeModal(memberModal));
      }
      if (memberCancelBtn) {
      ...
      if (detailSelect && detailContent) {
        detailSelect.addEventListener("change", function () {
          const sections = detailContent.querySelectorAll(".content-section");
      ...
      if (activitySelect && activityContent) {
        activitySelect.addEventListener("change", function () {
          const sections = activityContent.querySelectorAll(".content-section");
          sections.forEach((section) => {
            section.style.display = "none";
          });
